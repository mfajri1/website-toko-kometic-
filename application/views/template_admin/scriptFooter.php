		...
		<!-- <link rel="stylesheet" href="<?= base_url('assets/admin/') ;?>js/jquery-ui.js"> -->
		...
		<!-- jqury-image-reader -->
		<script src="<?= base_url('assets/admin/') ;?>jquery-image-reader-master/jquery.imagereader-1.1.0.js"></script>

		

		<!-- script sendiri untuk data script tampil -->
		<script src="<?= base_url('assets/admin/') ;?>js/scriptSendiri/scriptLogin.js"></script>
		<script src="<?= base_url('assets/admin/') ;?>js/scriptSendiri/scriptDashboard.js"></script>
		<script src="<?= base_url('assets/admin/') ;?>js/scriptSendiri/scriptBarang.js"></script>
