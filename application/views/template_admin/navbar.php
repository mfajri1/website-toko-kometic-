<div class="main-header">
	...
	<div class="logo-header" data-background-color="blue">
		...
		<a href="index.html" class="logo">
			...
			<span class="navbar-brand" style="color: white">Toko Batra</span>
		</a>
				...
				<li class="nav-item dropdown hidden-caret">
					...
					<ul class="dropdown-menu dropdown-user animated fadeIn">
						<div class="dropdown-user-scroll scrollbar-outer">
							<li>
								<div class="user-box">
									<div class="avatar-lg"><img src="<?= base_url('assets/admin/uploads/users/') . $this->session->userdata('fotoUser') ;?>" alt="image profile" class="avatar-img rounded"></div>
									<div class="u-text">
										<h4><?= ucwords($konfigUser['namaUser']) ;?></h4>
										<p class="text-muted"><?= $konfigUser['emailUser'] ;?></p>
							...
							<li>
								...
								<!-- <a class="dropdown-item" href="<?= base_url('editProfile') ;?>"><i class="fas fa-user-edit"></i> Edit Profile</a> -->
								<a class="dropdown-item" href="<?= base_url('settingProfile') ;?>"><i class="fas fa-user-cog"></i> Account Setting</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item logout" href="<?= base_url('Auth/logout') ;?>"><i class="fas fa-sign-out-alt"></i> Logout</a>
							</li>
						</div>
					</ul>
				</li>
